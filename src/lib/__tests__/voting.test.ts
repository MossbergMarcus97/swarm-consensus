...
const baseCandidates: CandidateAnswer[] = [
  {
    ...
    workerSystemPrompt: "You are Worker A",
    workerModel: "test-model",
    initialAnswer: "Answer A",
    initialReasoning: "Reasoning A",
    answer: "Answer A",
  ...
  },
  {
    ...
    workerSystemPrompt: "You are Worker B",
    workerModel: "test-model",
    initialAnswer: "Answer B",
    initialReasoning: "Reasoning B",
    answer: "Answer B",
